...
nodes["ArgusCore"] = {
	...
	{ coord=73207080, npcId=127090, questId=48817, icon="skull_grey", group="rare_aw", label="雷尔瓦将军", search="将军", loot={ { 153324, itemTypeTransmog, "盾牌" } }, note=nil },
	{ coord=76155614, npcId=127096, questId=48818, icon="skull_grey", group="rare_aw", label="全知者萨纳里安", search="全知者", loot=nil, note=nil },
	{ coord=50905530, npcId=127118, questId=48820, icon="skull_grey", group="rare_aw", label="裂世者斯库尔", search="裂世者", loot={ { 153312, itemTypeTransmog, "双手剑" } }, note="会在天上盘旋。偶尔也会降落。不是每次盘旋都这样。" },
	...
	{ coord=54003800, npcId=127581, questId=48966, icon="skull_grey", group="rare_aw", label="千面吞噬者", search="千面", loot={ { 153195, itemTypePet, 2136 } }, note=nil },
	...
	{ coord=63682571, questId=48384, icon="treasure", group="treasure_aw", label="48384", loot=nil, note=nil },
...
-- Krokuun
nodes["ArgusSurface"] = {
	{ coord=44390734, npcId=125824, questId=48561, icon="skull_grey", group="rare_kr", label="卡扎杜姆", search="卡扎杜姆", loot={ { 153316, itemTypeTransmog, "双手剑" } }, note="入口在东南位于 50.3, 17.3" },
	{ coord=33007600, npcId=122912, questId=48562, icon="skull_grey", group="rare_kr", label="指挥官萨森纳尔", search="萨森纳尔", loot=nil, note=nil },
	{ coord=44505870, npcId=124775, questId=48564, icon="skull_grey", group="rare_kr", label="指挥官安达西斯", search="安达西斯", loot={ { 153255, itemTypeTransmog, "单手锤" } }, note=nil },
	...
	{ coord=54688126, npcId=123689, questId=48628, icon="skull_grey", group="rare_kr", label="恶毒者泰勒斯塔", search="恶毒者", loot={ { 153329, itemTypeTransmog, "匕首" } }, note=nil },
	{ coord=38145920, npcId=122911, questId=48563, icon="skull_grey", group="rare_kr", label="指挥官维卡娅", search="维卡娅", loot={ { 153299, itemTypeTransmog, "单手剑" } }, note="路径起始点在东，位于 42, 57.1" },
	{ coord=60802080, npcId=125388, questId=48629, icon="skull_grey", group="rare_kr", label="背弃者瓦加斯", search="背弃者", loot=nil, note=nil },
	{ coord=69605750, npcId=124804, questId=48664, icon="skull_grey", group="rare_kr", label="分选者泰瑞克", search="分选者", loot={ { 153263, itemTypeTransmog, "单手斧" } }, note=nil },
...
nodes["ArgusCitadelSpire"] = {
	{ coord=38954032, npcId=125824, questId=48561, icon="skull_grey", group="rare_kr", label="卡扎杜姆", loot={ { 153316, itemTypeTransmog, "双手剑" } }, note=nil },
}

-- Mac'Aree
nodes["ArgusMacAree"] = {
	{ coord=52976684, npcId=126815, questId=48693, icon="skull_grey", group="rare_ma", label="灵魂扭曲的畸体", search="畸体", loot=nil, note=nil },
	{ coord=55536016, npcId=126852, questId=48695, icon="skull_grey", group="rare_ma", label="牧羊人卡沃斯", search="牧羊人", loot=nil, note=nil },
	...
	{ coord=41121149, npcId=126864, questId=48702, icon="skull_grey", group="rare_ma", label="麦芬大盗费舍尔", search="大盗", loot=nil, note="打断钻地" },
	{ coord=36682383, npcId=126865, questId=48703, icon="skull_grey", group="rare_ma", label="警卫泰诺斯", search="泰诺斯", loot=nil, note=nil },
	{ coord=63806460, npcId=126866, questId=48704, icon="skull_grey", group="rare_ma", label="警卫库洛", search="库洛", loot=nil, note=nil },
	{ coord=33654801, npcId=126867, questId=48705, icon="skull_grey", group="rare_ma", label="毒尾天鳍鳐", search="毒尾", loot=nil, note=nil },
	{ coord=38226435, npcId=126868, questId=48706, icon="skull_grey", group="rare_ma", label="清醒者图瑞克", search="清醒者", loot=nil, note="下楼进入建筑物" },
	{ coord=27192995, npcId=126869, questId=48707, icon="skull_grey", group="rare_ma", label="法鲁克队长", search="队长", loot=nil, note=nil },
	{ coord=70294598, npcId=126889, questId=48710, icon="skull_grey", group="rare_ma", label="厄运者索洛里斯", search="厄运者", loot=nil, note=nil },
	...
	{ coord=58783762, npcId=124440, questId=48714, icon="skull_grey", group="rare_ma", label="监视者伊比达", search="伊比达", loot=nil, note=nil },
	{ coord=58003090, npcId=125497, questId=48716, icon="skull_grey", group="rare_ma", label="监视者伊索纳", search="伊索纳", loot=nil, note=nil },
	...
	{ coord=61575035, npcId=126900, questId=48718, icon="skull_grey", group="rare_ma", label="导师塔拉娜", search="导师", loot={ { 153179, itemTypeToy } }, note=nil },
	...
	{ coord=49870953, npcId=126912, questId=48721, icon="skull_grey", group="rare_ma", label="吞噬者斯克里格", search="吞噬者", loot=nil, note=nil },
	...
	{ coord=35203720, npcId=126885, questId=48708, icon="skull_grey", group="rare_ma", label="乌伯拉利斯", search="乌伯拉利斯", loot=nil, note=nil },

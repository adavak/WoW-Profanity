...
nodes["ArgusCore"] = {
	...
	{ coord = 73207080, npcId = 127090, questId = 48817, icon = "skull_grey", group = "rare_aw", label = _L["Admiral Rel'var"], search = _L["Admiral Rel'var_search"], loot = { { 153324, itemTypeTransmog, "盾牌" }, { 152886, itemTypeTransmog, "布甲" }, { 152888, itemTypeTransmog, "布甲" }, { 152884, itemTypeTransmog, "布甲" }, { 152889, itemTypeTransmog, "布甲" }, { 152885, itemTypeTransmog, "布甲" }, { 152881, itemTypeTransmog, "布甲" }, { 152887, itemTypeTransmog, "布甲" }, { 152883, itemTypeTransmog, "布甲" } }, note = _L["Admiral Rel'var_note"] },
	...
	{ coord = 55702190, npcId = 127300, questId = 48824, icon = "skull_grey", group = "rare_aw", label = _L["Void Warden Valsuran"], search = _L["Void Warden Valsuran_search"], loot = { { 153319, itemTypeTransmog, "双手锤" }, { 152886, itemTypeTransmog, "布甲" }, { 152888, itemTypeTransmog, "布甲" }, { 152884, itemTypeTransmog, "布甲" }, { 152889, itemTypeTransmog, "布甲" }, { 152885, itemTypeTransmog, "布甲" }, { 152881, itemTypeTransmog, "布甲" }, { 152887, itemTypeTransmog, "布甲" }, { 152883, itemTypeTransmog, "布甲" } }, note = _L["Void Warden Valsuran_note"] },
...
-- Krokuun
nodes["ArgusSurface"] = {
	{ coord = 44390734, npcId = 125824, questId = 48561, icon = "skull_grey", group = "rare_kr", label = _L["Khazaduum"], search = _L["Khazaduum_search"], loot = { { 153316, itemTypeTransmog, "双手剑" }, { 152946, itemTypeTransmog, "板甲" }, { 152944, itemTypeTransmog, "板甲" }, { 152949, itemTypeTransmog, "板甲" }, { 152942, itemTypeTransmog, "板甲" }, { 152947, itemTypeTransmog, "板甲" }, { 152943, itemTypeTransmog, "板甲" }, { 152945, itemTypeTransmog, "板甲" }, { 152948, itemTypeTransmog, "板甲" } }, note = _L["Khazaduum_note"] },
	...
	{ coord = 44505870, npcId = 124775, questId = 48564, icon = "skull_grey", group = "rare_kr", label = _L["Commander Endaxis"], search = _L["Commander Endaxis_search"], loot = { { 153255, itemTypeTransmog, "单手锤" }, { 152946, itemTypeTransmog, "板甲" }, { 152944, itemTypeTransmog, "板甲" }, { 152949, itemTypeTransmog, "板甲" }, { 152942, itemTypeTransmog, "板甲" }, { 152947, itemTypeTransmog, "板甲" }, { 152943, itemTypeTransmog, "板甲" }, { 152945, itemTypeTransmog, "板甲" }, { 152948, itemTypeTransmog, "板甲" } }, note = _L["Commander Endaxis_note"] },
	...
	{ coord = 54688126, npcId = 123689, questId = 48628, icon = "skull_grey", group = "rare_kr", label = _L["Talestra the Vile"], search = _L["Talestra the Vile_search"], loot = { { 153329, itemTypeTransmog, "匕首" }, { 152946, itemTypeTransmog, "板甲" }, { 152944, itemTypeTransmog, "板甲" }, { 152949, itemTypeTransmog, "板甲" }, { 152942, itemTypeTransmog, "板甲" }, { 152947, itemTypeTransmog, "板甲" }, { 152943, itemTypeTransmog, "板甲" }, { 152945, itemTypeTransmog, "板甲" }, { 152948, itemTypeTransmog, "板甲" } }, note = _L["Talestra the Vile_note"] },
	{ coord = 38145920, npcId = 122911, questId = 48563, icon = "skull_grey", group = "rare_kr", label = _L["Commander Vecaya"], search = _L["Commander Vecaya_search"], loot = { { 153299, itemTypeTransmog, "单手剑" }, { 152946, itemTypeTransmog, "板甲" }, { 152944, itemTypeTransmog, "板甲" }, { 152949, itemTypeTransmog, "板甲" }, { 152942, itemTypeTransmog, "板甲" }, { 152947, itemTypeTransmog, "板甲" }, { 152943, itemTypeTransmog, "板甲" }, { 152945, itemTypeTransmog, "板甲" }, { 152948, itemTypeTransmog, "板甲" } }, note = _L["Commander Vecaya_note"] },
	...
	{ coord = 69605750, npcId = 124804, questId = 48664, icon = "skull_grey", group = "rare_kr", label = _L["Tereck the Selector"], search = _L["Tereck the Selector_search"], loot = { { 153263, itemTypeTransmog, "单手斧" }, { 152946, itemTypeTransmog, "板甲" }, { 152944, itemTypeTransmog, "板甲" }, { 152949, itemTypeTransmog, "板甲" }, { 152942, itemTypeTransmog, "板甲" }, { 152947, itemTypeTransmog, "板甲" }, { 152943, itemTypeTransmog, "板甲" }, { 152945, itemTypeTransmog, "板甲" }, { 152948, itemTypeTransmog, "板甲" } }, note = _L["Tereck the Selector_note"] },
...
-- Mac'Aree
nodes["ArgusMacAree"] = {
	{ coord = 44607160, npcId = 122838, questId = 48692, icon = "skull_grey", group = "rare_ma", label = _L["Shadowcaster Voruun"], search = _L["Shadowcaster Voruun_search"], loot = { { 153296, itemTypeTransmog, "单手剑" } }, note = _L["Shadowcaster Voruun_note"] },
	...
	{ coord = 55536016, npcId = 126852, questId = 48695, icon = "skull_grey", group = "rare_ma", label = _L["Wrangler Kravos"], search = _L["Wrangler Kravos_search"], loot = { { 153269, itemTypeTransmog, "单手斧" }, { 152814, itemTypeMount, 970 } }, note = _L["Wrangler Kravos_note"] },
	...
	{ coord = 36682383, npcId = 126865, questId = 48703, icon = "skull_grey", group = "rare_ma", label = _L["Vigilant Thanos"], search = _L["Vigilant Thanos_search"], loot = { { 153322, itemTypeTransmog, "盾牌" } }, note = _L["Vigilant Thanos_note"] },
	{ coord = 63806460, npcId = 126866, questId = 48704, icon = "skull_grey", group = "rare_ma", label = _L["Vigilant Kuro"], search = _L["Vigilant Kuro_search"], loot = { { 153323, itemTypeTransmog, "盾牌" }, { 153183, itemTypeToy } }, note = _L["Vigilant Kuro_note"] },
	...
	{ coord = 38226435, npcId = 126868, questId = 48706, icon = "skull_grey", group = "rare_ma", label = _L["Turek the Lucid"], search = _L["Turek the Lucid_search"], loot = { { 153306, itemTypeTransmog, "单手斧" } }, note = _L["Turek the Lucid_note"] },
	...
	{ coord = 70294598, npcId = 126889, questId = 48710, icon = "skull_grey", group = "rare_ma", label = _L["Sorolis the Ill-Fated"], search = _L["Sorolis the Ill-Fated_search"], loot = { { 153292, itemTypeTransmog, "法杖" } }, note = _L["Sorolis the Ill-Fated_note"] },
	...
	{ coord = 48504090, npcId = 126899, questId = 48713, icon = "skull_grey", group = "rare_ma", label = _L["Jed'hin Champion Vorusk"], search = _L["Jed'hin Champion Vorusk_search"], loot = { { 153302, itemTypeTransmog, "单手剑" } }, note = _L["Jed'hin Champion Vorusk_note"] },
	{ coord = 58783762, npcId = 124440, questId = 48714, icon = "skull_grey", group = "rare_ma", label = _L["Overseer Y'Beda"], search = _L["Overseer Y'Beda_search"], loot = { { 153315, itemTypeTransmog, "双手剑" } }, note = _L["Overseer Y'Beda_note"] },
	{ coord = 58003090, npcId = 125497, questId = 48716, icon = "skull_grey", group = "rare_ma", label = _L["Overseer Y'Sorna"], search = _L["Overseer Y'Sorna_search"], loot = { { 153268, itemTypeTransmog, "单手斧" } }, note = _L["Overseer Y'Sorna_note"] },
	{ coord = 60982982, npcId = 125498, questId = 48717, icon = "skull_grey", group = "rare_ma", label = _L["Overseer Y'Morna"], search = _L["Overseer Y'Morna_search"], loot = { { 153257, itemTypeTransmog, "单手锤" } }, note = _L["Overseer Y'Morna_note"] },
	{ coord = 61575035, npcId = 126900, questId = 48718, icon = "skull_grey", group = "rare_ma", label = _L["Instructor Tarahna"], search = _L["Instructor Tarahna_search"], loot = { { 153309, itemTypeTransmog, "单手锤" }, { 153179, itemTypeToy }, { 153180, itemTypeToy }, { 153181, itemTypeToy } }, note = _L["Instructor Tarahna_note"] },

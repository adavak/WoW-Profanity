...
-- ! DEV FUNCTIONALITY ! --
-- local QuestIDs = GetQuestsCompleted();
-- function Addon:GetLastQuestID(QuestIDs)
--     local newQuestIDs = GetQuestsCompleted();
--     for i,v in pairs(newQuestIDs) do
--         if QuestIDs[i] == nil then 
--             QuestIDs[i] = v;
--             return i;
--         end
--     end
...
-- SLASH_QID1 = "/qid";
-- function SlashCmdList.QID(msg, editbox)
--     print(Addon:GetLastQuestID(QuestIDs));
-- end

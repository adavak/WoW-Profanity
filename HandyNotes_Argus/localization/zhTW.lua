...
_L["Chief Alchemist Munculus_search"] = { "首席鍊金師", "孟庫勒斯" };
_L["Chief Alchemist Munculus_note"] = "";
_L["The Many-Faced Devourer"] = "多面者";
_L["The Many-Faced Devourer_search"] = { "面" };

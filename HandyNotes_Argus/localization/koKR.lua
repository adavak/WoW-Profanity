...
_L["48351_46917346_note"] = "나무 아래에 숨겨져 있습니다";
...
_L["invasion_val_search"] = { "발", "침공.*발", "발.*침공" };
_L["invasion_aurinor_search"] = { "아우리노르", "아우리노르" };
_L["invasion_sangua_search"] = { "센구아", "센구아" };
_L["invasion_naigtal_search"] = { "나익탈", "나익탈" };
_L["invasion_bonich_search"] = { "보니크", "보니크" };
_L["invasion_cengar_search"] = { "센가르", "센가르" };
_L["invasion_alluradel_search"] = { "알루", "알루라델" };
...
_L["chatmsg_group_created"] = "%s 파티를 만들었습니다.";
...
_L["listing_desc_rare"] = "아르거스의 %s 희귀 몬스터와 전투를 벌입니다.";
...
_L["context_menu_add_tomtom"] = "이 위치를 TomTom 웨이포인트에 추가";
